...
#define STRING_CONFIG_H_AUTHOR "(Lexio, Ender-3-SKR-mini-E3-V3.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Pipsqueak"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 407.75 }
